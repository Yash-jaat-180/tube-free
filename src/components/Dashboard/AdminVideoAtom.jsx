...
import { deleteVideo, togglePublish } from '../../app/Slice/videoSlice';
import { getChannalVideos } from '../../app/Slice/dashboardSlice';
import { formatDate } from '../../helper/formatFigures';
    ...
    return (
        <tr key={video._id} className="group border">
            ...
            <td className="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
                <div className="flex justify-center">
                    <span
                        className={`inline-block rounded-2xl border px-1.5 py-0.5 ${publishedStatus
