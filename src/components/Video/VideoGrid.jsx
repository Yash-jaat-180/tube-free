...
function VideoCards({ videos = [], loading = true, fecthing = false }) {
    if (loading) {
        return (
                                    ...
                                    <li>
                                        <div className="w-full">
                                            <div className="relative mb-2 w-full pt-[56%]">
                                                ...
                                                <span className="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">{formatVideoDuration(video?.duration)}</span>
                                            </div>
                                            <div className="flex gap-x-2">
                                                ...
                                                <div className="w-full">
                                                    ...
                                                    <p className="flex text-sm text-gray-200">{video.views} Views · {formatTimestamp(video.createdAt)}</p>
