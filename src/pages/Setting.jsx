...
import { uploadAvatar, uploadCoverImage } from '../app/Slice/authSlice';
                ...
                <ul className="no-scrollbar sticky top-[66px] z-[2] flex flex-row gap-x-2 overflow-auto border-b-2 border-gray-400 bg-[#121212] py-2 sm:top-[82px]">
                    <li key="personel-info" className="w-full">
                        <button
                            ...
                            className={`w-full border-b-2 ${currentTab === 0
                    ...
                    <li key="channel-info" className="w-full">
                        <button
                            ...
                            className={`w-full border-b-2 px-3 py-1.5 ${currentTab === 1
                    ...
                    <li key="change-pwd" className="w-full">
                        <button
                            ...
                            className={`w-full border-b-2 px-3 py-1.5 ${currentTab === 2
                                    ? "border-[#ae7aff] text-[#ae7aff] bg-white"
                                    : "border-transparent text-gray-400"
                                } `}
                        >
